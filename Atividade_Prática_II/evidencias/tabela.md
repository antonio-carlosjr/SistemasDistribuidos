...
**46 de 46 cenarios com resultado igual ao esperado.**
...
| 5 | Obter oficina | `GET /oficinas/14` | 200 | 200 | - | OK |
| 6 | Listar inscricoes da oficina | `GET /oficinas/14/inscricoes` | 200 | 200 | - | OK |
...
| 9 | Inscrever com e-mail malformado | `POST /oficinas/14/inscricoes` | 422 | 422 | entrada_invalida | OK |
...
| # | Cenario | Requisicao | Esperado | Obtido | Codigo | Resultado |
| --- | --- | --- | --- | --- | --- | --- |
| 14 | Obter com If-None-Match atual | `GET /oficinas/14` | 304 | 304 | - | OK |
| | _Representacao inalterada: resposta sem corpo_ | | | | | |
| 15 | Alterar sem If-Match | `PATCH /oficinas/14` | 428 | 428 | precondicao_obrigatoria | OK |
| | _A precondicao e exigida para evitar perda de atualizacao_ | | | | | |
| 16 | Alterar com ETag inexistente | `PATCH /oficinas/14` | 412 | 412 | precondicao_falhou | OK |
| 17 | Alterar com ETag correto | `PATCH /oficinas/14` | 200 | 200 | - | OK |
| | _A versao avanca e o ETag anterior deixa de valer_ | | | | | |
| 18 | Repetir a alteracao com o ETag ja consumido | `PATCH /oficinas/14` | 412 | 412 | precondicao_falhou | OK |
| | _Perda de atualizacao detectada em vez de sobrescrita silenciosa_ | | | | | |
| 19 | Reler para obter o ETag vigente | `GET /oficinas/14` | 200 | 200 | - | OK |
| 20 | Substituir com If-Match vigente | `PUT /oficinas/14` | 200 | 200 | - | OK |
## Conflitos de dominio (409)

| # | Cenario | Requisicao | Esperado | Obtido | Codigo | Resultado |
| --- | --- | --- | --- | --- | --- | --- |
| 21 | Inscrever participante | `POST /oficinas/14/inscricoes` | 201 | 201 | - | OK |
| 22 | Inscrever o mesmo e-mail de novo | `POST /oficinas/14/inscricoes` | 409 | 409 | inscricao_duplicada | OK |
| | _Repetir POST aqui conflita, em vez de duplicar_ | | | | | |
| 23 | Inscrever um segundo participante | `POST /oficinas/14/inscricoes` | 201 | 201 | - | OK |
| | _Leva a oficina a duas vagas ocupadas de tres_ | | | | | |
| 24 | Remover oficina com inscritos | `DELETE /oficinas/14` | 409 | 409 | oficina_com_inscricoes | OK |
| | _409 e nao 403: o impedimento vem do estado, nao da permissao_ | | | | | |
| 25 | Reduzir vagas abaixo do ocupado | `PATCH /oficinas/14` | 409 | 409 | vagas_abaixo_do_ocupado | OK |
| | _Ha duas inscricoes ativas; aceitar deixaria estado impossivel_ | | | | | |
| 26 | Transicao de status invalida | `PATCH /oficinas/14` | 409 | 409 | transicao_invalida | OK |
| 27 | Criar oficina de vaga unica | `POST /oficinas` | 201 | 201 | - | OK |
| 28 | Ocupar a unica vaga | `POST /oficinas/16/inscricoes` | 201 | 201 | - | OK |
| 29 | Inscrever com a oficina lotada | `POST /oficinas/16/inscricoes` | 409 | 409 | oficina_lotada | OK |
| 30 | Criar oficina em rascunho | `POST /oficinas` | 201 | 201 | - | OK |
| 31 | Inscrever em oficina nao aberta | `POST /oficinas/17/inscricoes` | 409 | 409 | oficina_nao_aberta | OK |
## Idempotencia

| # | Cenario | Requisicao | Esperado | Obtido | Codigo | Resultado |
| --- | --- | --- | --- | --- | --- | --- |
| 32 | Marcar presenca | `PATCH /inscricoes/8` | 200 | 200 | - | OK |
| 33 | Cancelar inscricao | `DELETE /inscricoes/8` | 204 | 204 | - | OK |
| 34 | Cancelar a mesma inscricao de novo | `DELETE /inscricoes/8` | 204 | 204 | - | OK |
| | _Mesmo efeito e mesmo status: idempotente_ | | | | | |
| 35 | Reativar inscricao cancelada | `PATCH /inscricoes/8` | 409 | 409 | transicao_invalida | OK |
| | _Reativar sem reavaliar capacidade furaria o limite de vagas_ | | | | | |
| 36 | Cancelar a segunda inscricao | `DELETE /inscricoes/9` | 204 | 204 | - | OK |
| | _Esvazia a oficina para o cenario de remocao_ | | | | | |
| 37 | Reler a oficina liberada | `GET /oficinas/14` | 200 | 200 | - | OK |
| 38 | Remover oficina sem inscritos | `DELETE /oficinas/14` | 204 | 204 | - | OK |
| 39 | Remover a mesma oficina de novo | `DELETE /oficinas/14` | 404 | 404 | nao_encontrado | OK |
